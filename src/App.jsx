  ...
  return (
    <div className="min-h-screen bg-[#F2F2F2]">
      <div className="sm:p-4 lg:p-6 max-w-[1600px] mx-auto pt-2 px-2">
        ...
        <header className="min-h-[500px] bg-stone-900 rounded-[2rem] relative shadow-2xl overflow-hidden animate-fade-in">
          ...
          <div className="relative z-10 px-6 sm:px-10 pb-12">
            <div className="max-w-2xl mb-8">
              <span className="inline-block uppercase text-xs font-medium text-white tracking-wider bg-white/20 border-white/10 border rounded-full mb-4 pt-1 pr-3 pb-1 pl-3 backdrop-blur-md animate-fade-in-up stagger-1">
                Flight Search Engine
              </span>
              <h1 className="text-4xl sm:text-5xl lg:text-6xl leading-[1.1] font-medium text-white tracking-tight mb-6 animate-fade-in-up stagger-2">
                Find Your Perfect Flight
              </h1>
              <p className="text-lg font-light text-white/80 max-w-lg animate-fade-in-up stagger-3">
        ...
        {/* Search Form */}
        <div className="mt-[-80px] relative z-20 px-4 sm:px-6 animate-scale-in stagger-4">
          <SearchForm onSearch={handleSearch} />
        </div>

        {/* Error State */}
        {error && (
          <div className="mt-12 bg-red-50 border border-red-200 rounded-2xl p-6 mx-4 sm:mx-6 animate-fade-in">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-6">
              ...
              <div className="lg:col-start-2">
                ...
                {sortedFlights && sortedFlights.length > 0 && (
                  <div className="mb-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 animate-fade-in">
                    ...
                    <select
                      ...
                      className="bg-white border border-stone-200 rounded-xl px-4 py-2 text-sm text-stone-700 focus:ring-2 focus:ring-stone-900 focus:outline-none w-full sm:w-auto"
                    >
